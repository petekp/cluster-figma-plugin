import { convertNamedColorToHexColor, isValidHexColor } from '@create-figma-plugin/utilities';
export function normalizeUserInputColor(string) {
...
//# sourceMappingURL=normalize-hex-color.js.map