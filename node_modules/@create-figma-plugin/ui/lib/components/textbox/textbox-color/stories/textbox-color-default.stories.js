...
export const PlaceholderFocused = function () {
    ...
    return (h(TextboxColor, { ...useInitialFocus(), hexColor: hexColor, hexColorPlaceholder: "Color", onHexColorInput: handleHexColorInput, onOpacityInput: handleOpacityInput, opacity: opacity, opacityPlaceholder: "%" }));
};
