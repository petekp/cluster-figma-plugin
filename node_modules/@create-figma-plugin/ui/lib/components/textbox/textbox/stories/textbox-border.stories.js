...
export const PlaceholderFocused = function () {
    ...
    return (h(Textbox, { ...useInitialFocus(), onInput: handleInput, placeholder: "placeholder", value: value, variant: "border" }));
};
...
export const IconText = function () {
    ...
    return (h(Textbox, { icon: "X", onInput: handleInput, value: value, variant: "border" }));
};
export const IconTextDisabled = function () {
    ...
    return (h(Textbox, { disabled: true, icon: "X", onInput: handleInput, value: value, variant: "border" }));
};
