...
import { RawTextboxNumeric } from './private/raw-textbox-numeric';
import textboxNumericStyles from './textbox-numeric.module.css';
export function TextboxNumeric({ icon, variant, ...rest }) {
    ...
    return (h("div", { class: createClassName([
        ...
        ]) }, h(RawTextboxNumeric, { ...rest, class: createClassName([
            textboxStyles.input,
            textboxNumericStyles.input
        ]) }), typeof icon === "undefined" ? null : (h("div", { class: textboxStyles.icon }, icon)), h("div", { class: textboxStyles.border }), variant === "underline" ? h("div", { class: textboxStyles.underline }) : null));
}
