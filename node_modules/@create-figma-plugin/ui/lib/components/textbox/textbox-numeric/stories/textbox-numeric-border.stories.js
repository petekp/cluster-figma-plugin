...
export const PlaceholderFocused = function () {
    ...
    return (h(TextboxNumeric, { ...useInitialFocus(), onInput: handleInput, placeholder: "placeholder", value: value, variant: "border" }));
};
...
export const IconDisabled = function () {
    ...
    return (h(TextboxNumeric, { disabled: true, icon: h(IconLayerFrame16, null), onInput: handleInput, value: value, variant: "border" }));
};
export const IconText = function () {
    ...
    return (h(TextboxNumeric, { icon: "X", onInput: handleInput, value: value, variant: "border" }));
};
export const IconTextDisabled = function () {
    ...
    return (h(TextboxNumeric, { disabled: true, icon: "X", onInput: handleInput, value: value, variant: "border" }));
};
...
export const CustomIncrements = function () {
    ...
    return (h(TextboxNumeric, { incrementBig: 8, incrementSmall: 4, onInput: handleInput, value: value, variant: "border" }));
};
...
export const SuffixMixed = function () {
    ...
    return (h(TextboxNumeric, { onInput: handleInput, suffix: "%", value: value, variant: "border" }));
};
export const SuffixRevertOnEscapeKeyDown = function () {
    ...
    return (h(TextboxNumeric, { maximum: 100, minimum: 0, onInput: handleInput, revertOnEscapeKeyDown: true, suffix: "%", value: value, variant: "border" }));
};
export const SuffixValidateOnBlur = function () {
    ...
    return (h(TextboxNumeric, { maximum: 100, minimum: 0, onInput: handleInput, revertOnEscapeKeyDown: true, suffix: "%", validateOnBlur: validateOnBlur, value: value, variant: "border" }));
};
