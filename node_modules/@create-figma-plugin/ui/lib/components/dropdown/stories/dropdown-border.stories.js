...
export const IconDisabled = function () {
    ...
    return (h(Dropdown, { disabled: true, icon: h(IconLayerFrame16, null), onChange: handleChange, options: options, value: value, variant: "border" }));
};
export const IconText = function () {
    ...
    return (h(Dropdown, { icon: "X", onChange: handleChange, options: options, value: value, variant: "border" }));
};
export const IconTextDisabled = function () {
    ...
    return (h(Dropdown, { disabled: true, icon: "X", onChange: handleChange, options: options, value: value, variant: "border" }));
};
export const DynamicallySetOptions = function () {
    ...
    return (h(Fragment, null, h(Button, { onClick: handleClick }, "Set"), h(VerticalSpace, { space: "small" }), h(Dropdown, { onChange: handleChange, options: options, placeholder: "placeholder", value: value, variant: "border" })));
};
export const FlexParent = function () {
    ...
    return (h("div", { style: style }, h(Dropdown, { onChange: handleChangeA, options: optionsA, value: valueA, variant: "border" }), ")", h(Dropdown, { onChange: handleChangeB, options: optionsB, value: valueB, variant: "border" }), ")"));
};
...
export const TopLeft = function () {
    ...
    return (h("div", { style: style }, h(Dropdown, { onChange: handleChange, options: options, value: value, variant: "border" })));
};
